...
import json
import shutil
from utils.sys_ops import get_config_path, create_custom_path, get_models_path
from utils.request_util import get_mode, get_cy_model, get_data, get_loss, get_model_name
...
def save_local_model(local_sess, request, APP_ROOT, username):
    ...
    if get_mode(request) == 'custom':
        ...
        path = get_models_path(APP_ROOT, username)
        ...
        custom_path = create_custom_path(APP_ROOT, username, model_name)
    ...
    config_path = get_config_path(APP_ROOT, username, local_sess.get_model_name())
